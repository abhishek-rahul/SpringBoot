...
public class EmployeeController {
	...
	@GetMapping("/selectedemployees")
	public List<Employee> getSelectedEmployees() {
		return employeeRepository.findAllSelectedEmployee();
	}
	
	@GetMapping("/singleemployee")
	public List<Employee> getSingleEmployee() {
		return employeeRepository.findSingleEmployee("kriti");
	}
